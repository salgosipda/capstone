												...
												if (map.zoom >= 17) {
													for (let i = 0; i < Estates.length; i++) {
														...
														if (Estates[i].x_coord < bounds
															...
															var contentstring = [ '<div style="width:150px;text-align:center;padding:10px;">'
																	+ Estates[i].name
																	+ '<br>'
																	+ Estates[i].type
																	+ Estates[i].price
																	/* + '<button type='button' id="detailbutton">상세정보</button>' */
															...
															detailview += "<br>";
															detailview += Estates[i].type;
															detailview += "<br>";
															detailview += Estates[i].price; 
															detailview += "<br>";
															detailview += Estates[i].address;
															detailview += "<br>";
															detailview += '<img src="' + imgres + '" >';  
															/* detailview += Estates[i].id; */
															/* detailview += ".jpg"/>";  */
													...
													function getClickHandler(
														...
														return function(e) {
															...
															var marker = markerList[seq], infoWindow = infoWindows[seq], detailview=detailviews[seq];
															//매물 상세정보창 
																...
																document
																.getElementById("detailview").innerHTML = detailview;
